    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="/admin/katalog/{{ $katalog->id }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="file_buku">File Buka PA</label>
                    <input type="file" class="form-control @error('file_buku') is-invalid @enderror" name="file_buku" id="file_buku" value="{{ old('file_buku', $katalog->file_buku) }}">
                    @error('file_buku')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
