    ...
    <div class="row">
        <div class="col gray-bg">
            ...
            <form action="/daftarHKI" method="post" enctype="multipart/form-data">
                @csrf
                <div class=" row">
                    <label for="nama_pengusul" class="col-sm-4 col-form-label">Nama Pengusul</label>
                    <div class="col-sm-7">
                        <input class="form-control form-control-sm @error('nama_pengusul') is-invalid @enderror" id="nama_pengusul" name="nama_pengusul" type="text" value="{{ old('nama_pengusul') }}">
                        @error('nama_pengusul')
                ...
                <div class=" row">
                    <label for="nim_pengusul" class="col-sm-4 col-form-label">NIM Pengusul</label>
                    <div class="col-sm-7">
                        <input class="form-control form-control-sm @error('nim_pengusul') is-invalid @enderror" id="nim_pengusul" name="nim_pengusul" type="number" value="{{ old('nim_pengusul') }}">
                        @error('nim_pengusul')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
